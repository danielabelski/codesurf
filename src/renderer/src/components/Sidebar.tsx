...
import { SidebarTextDialog, type SidebarTextDialogState } from './sidebar/SidebarTextDialog'
import { SessionSidebarRow } from './sidebar/SessionSidebarRow'
...
} from './sidebar/session-indicators'
