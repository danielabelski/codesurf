...
import { Settings, Type, Monitor, Plus, Trash2, ChevronDown, ChevronRight, Puzzle, RefreshCw, Star, Wrench, Users, FileText, Globe, Eye, EyeOff, PanelRight, Pin, Shield, KeyRound, Image as ImageIcon, Video, Mic } from 'lucide-react'
