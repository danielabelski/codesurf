...
export const MODELS: Record<string, string[]> = {
  ...
  hermes:   ['openai-codex/gpt-5.6-sol', 'openai-codex/gpt-5.6-terra', 'openai-codex/gpt-5.6-luna', 'openai-codex/gpt-5.5', 'anthropic/claude-opus-5', 'openrouter/x-ai/grok-4.6'],
  shell:    []
}
